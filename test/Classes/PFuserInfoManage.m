...
//  Copyright © 2018年 多来美_单小飞. All rights reserved.
//

#import "PFuserInfoManage.h"
#import <objc/runtime.h>
static PFuserInfoManage *userInfo;
@implementation PFuserInfoManage
...
+ (instancetype)shareUser{
    ...
    dispatch_once(&once, ^{
        userInfo = [[PFuserInfoManage alloc]init];
    });
...
+ (void)configInfo:(NSDictionary *)infoDic{
    ...
    for (NSString *key in allKeys) {
        ...
        PFuserInfoManage *manager = [PFuserInfoManage shareUser];
